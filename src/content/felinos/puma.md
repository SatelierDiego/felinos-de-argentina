...
hero:
    ...
    image: "/src/assets/images/headshots/puma-concolor.jpg"
    alt: "Puma sobre rocas en un ambiente semiárido patagónico"

seo:
    title: "Puma (Puma concolor) | Felinos de Argentina"
    description: "Información sobre el puma: características, hábitat, comportamiento y amenazas. El felino de mayor distribución geográfica de América."
...
bibliography:
    - "Caso, A. et al. (2015). Puma concolor. The IUCN Red List of Threatened Species."
    ...
    - "Novaro, A.J. et al. (2000). Effect of prey availability on survival and home-range size of mountain lions in Patagonia. Journal of Mammalogy."
